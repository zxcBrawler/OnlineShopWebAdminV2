...
class DirectorMaleClothesWidget extends StatefulWidget {
  const DirectorMaleClothesWidget({super.key});

  @override
  State<DirectorMaleClothesWidget> createState() =>
      _DirectorMaleClothesWidgetState();
}

class _DirectorMaleClothesWidgetState extends State<DirectorMaleClothesWidget> {
  @override
                    ...
                    switch (state.runtimeType) {
                      ...
                      case RemoteShopGarnishDone:
                        ...
                        return Column(
                          children: [
                            BasicText(
                              title: 'total male clothes: $quantity',
                            ),
