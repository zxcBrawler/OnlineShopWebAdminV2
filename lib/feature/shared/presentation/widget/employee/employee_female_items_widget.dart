...
class EmployeeFemaleItemsWidget extends StatefulWidget {
  ...
  @override
  State<EmployeeFemaleItemsWidget> createState() =>
      _EmployeeFemaleItemsWidgetState();
}

class _EmployeeFemaleItemsWidgetState extends State<EmployeeFemaleItemsWidget> {
  @override
                  ...
                  children: [
                    Padding(
                      ...
                      child: IconButton(
                          ...
                          onPressed: () {
                            router.go(
                              Pages.employeeAllFemaleClothes.screenPath,
                            );
                          },
                          icon: const Icon(
                            Icons.chevron_right,
