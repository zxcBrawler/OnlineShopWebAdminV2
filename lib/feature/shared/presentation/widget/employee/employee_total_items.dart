...
class EmployeeTotalItems extends StatefulWidget {
  const EmployeeTotalItems({super.key});

  @override
  State<EmployeeTotalItems> createState() => _EmployeeTotalItemsState();
}

class _EmployeeTotalItemsState extends State<EmployeeTotalItems> {
  @override
