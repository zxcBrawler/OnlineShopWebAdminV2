...
class AdminAllMaleClothes extends StatefulWidget {
  const AdminAllMaleClothes({super.key});

  @override
  State<AdminAllMaleClothes> createState() => _AdminAllMaleClothesState();
}

class _AdminAllMaleClothesState extends State<AdminAllMaleClothes> {
  @override
