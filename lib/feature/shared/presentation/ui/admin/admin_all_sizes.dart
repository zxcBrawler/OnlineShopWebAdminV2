...
class AdminAllSizes extends StatefulWidget {
  ...
  @override
  State<AdminAllSizes> createState() => _AdminAllSizesState();
}

class _AdminAllSizesState extends State<AdminAllSizes> {
  @override
                    ...
                    child: BasicContainer(
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: BlocProvider<RemoteSizeBloc>(
                              create: (context) =>
                                  service()..add(const GetSizes()),
                              child: const SizesTable(),
                            ),
                          ),
                        ],
                      ),
