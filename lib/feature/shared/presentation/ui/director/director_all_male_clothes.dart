...
class DirectorAllMaleClothes extends StatefulWidget {
  const DirectorAllMaleClothes({super.key});

  @override
  State<DirectorAllMaleClothes> createState() => _DirectorAllMaleClothesState();
}

class _DirectorAllMaleClothesState extends State<DirectorAllMaleClothes> {
  @override
